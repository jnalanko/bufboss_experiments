...
resultdir = "fdbg_recsplit_results"
run("mkdir -p " + resultdir)

# Todo: does it do rc? seems no... build from forward + rc

# Build
run_to_files("/usr/bin/time -v ./FDBG-RecSplit/cpp-src/fdbg-recsplit-build " + build_concat_with_rc + " " + str(nodemer_k) + " " + built, resultdir + "/build")

# Add
run_to_files("/usr/bin/time -v ./FDBG-RecSplit/cpp-src/fdbg-recsplit-add " + add_concat_with_rc + " " + str(nodemer_k) + " " + built + " " + added, resultdir + "/add")

# Del
#run_to_files("/usr/bin/time -v ./FDBG-RecSplit/cpp-src/fdbg-recsplit-del " + del_concat_with_rc + " " + str(nodemer_k) + " " + added + " " + deleted, resultdir + "/del")
