...
datasets = ["20K", "200K", "2M", "11M", "55M", "150M", "600M"]
...
def parse_summaries(tablename):
    ...
    for dataset in datasets:
        ...
        else: time, mem, disk = "NA", "NA", "NA"
        print(disk + " & " + mem + " & " + time + " & ")
        
        if dataset != "150M" and dataset != "600M":
        ...
        if tablename == "del":
            ...
            else: time, mem, disk = "get", "get", "get"
            print(disk + " & " + mem + " & " + time + " \\\\ ")
...
table_prefix = """\\begin{table*}[h]
 ...
 \hline
 	&Disk  &Memory  & Time       &Disk  &Memory    & Time     &Disk &Memory &Time &Disk &Memory  &Time\\\\"""
