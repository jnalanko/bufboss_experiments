...
run_timed_rss(program + " query -g " + added+".gfa" + " -q " + query_random_edgemers + " -o " + query_out, "bifrost-query-random_edgemer", resultfile)
run_timed_rss(program + " query -g " + added+".gfa" + " -q " + query_random_sequence + " -o " + query_out, "bifrost-query-random-sequence", resultfile)
run_timed_rss(program + " query -g " + added+".gfa" + " -q " + query_existing_edgemers + " -o " + query_out, "bifrost-query-existing-edgemer", resultfile)
run_timed_rss(program + " query -g " + added+".gfa" + " -q " + query_existing_sequence + " -o " + query_out, "bifrost-query-existing-sequence", resultfile)
